                ...
                <div class="product-timeline card-body pt-2 mt-1">
                    <ul class="timeline-1 mb-0">
                        <li class="mt-0" id="mrg-8"> <i
                                ...
                                class="fw-semibold mb-4 tx-14 ">Total Products</span> <a href="javascript:void(0);"
                        ...
                        <li class="mt-0" id="mrg-8"> <i
                                ...
                                class="fw-semibold mb-4 tx-14 ">Total Sales</span> <a href="javascript:void(0);"
                        ...
                        <li class="mt-0" id="mrg-8"> <i
                                ...
                                class="fw-semibold mb-4 tx-14 ">Toatal Revenue</span> <a href="javascript:void(0);"
                        ...
                        <li class="mt-0" id="mrg-8"> <i
                                ...
                                class="fw-semibold mb-4 tx-14 ">Toatal Profit</span> <a href="javascript:void(0);"
                        ...
                        <li class="mt-0" id="mrg-8"> <i
                                ...
                                class="fw-semibold mb-4 tx-14 ">Customer Visits</span> <a href="javascript:void(0);"
                                class="float-end tx-11 text-muted">1 day ago</a>
                            <p class="mb-0 text-muted tx-12">15% increased</p>
                        </li>
                        <li class="mt-0 mb-0 mrg-8"> <i
                                class="icon-note icons bg-primary-gradient text-white product-icon"></i> <span
                                class="fw-semibold mb-4 tx-14 ">Customer Reviews</span> <a href="javascript:void(0);"
                                class="float-end tx-11 text-muted">1 day ago</a>
